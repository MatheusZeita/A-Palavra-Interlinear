...
Este documento descreve o método adotado para a produção do conteúdo interlinear do projeto **A Palavra Interlinear**, incluindo a escolha do texto-base, a segmentação das palavras, os critérios de tradução e a elaboração das notas explicativas.

## 1. Texto-base

### Escrituras Hebraicas

O texto hebraico utilizado é . . .
...
- A tradução de cada palavra é **a mais literal possível**, preservando o sentido básico e a ordem do idioma original.
